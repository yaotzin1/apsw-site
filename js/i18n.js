...
const APSW_TRANSLATIONS = {
  en: {
    ...
    career: {
      ...
      e1_desc: "Independent AI-native architecture practice. Authored the Spec-Kit methodology and Fully Agentic Development pipeline, delivering an autonomous multi-tenant B2B SaaS whose entire production codebase and test suites were synthesized by AI agents under formal architectural direction. Architected EMAP2, a multi-tenant industrial asset and preventative-maintenance platform built on recursive telemetry tree models.",
  ...
  pl: {
    ...
    career: {
      ...
      subtitle: "Ciągła ścieżka inżynierska od Junior Java Developera (2007) do Głównego Architekta Rozwiązań — pracodawcy wskazani z nazwy, projekty klientów chronione NDA.",
      e1_period: "2019 — Obecnie",
      e1_company: "APSW",
      e1_role: "Założyciel i Główny Architekt Rozwiązań",
      e1_desc: "Niezależna praktyka architektoniczna AI-Native. Autor metodyki Spec-Kit oraz procesu W Pełni Autonomicznego Rozwoju (Agentic Dev), w ramach którego powstał autonomiczny, wielodzierżawny system B2B SaaS — cały kod produkcyjny i testy zostały wygenerowane przez agentów AI pod formalnym nadzorem architektonicznym. Architekt EMAP2, wielodzierżawnej platformy zarządzania majątkiem przemysłowym i utrzymaniem prewencyjnym, opartej na rekurencyjnych modelach drzewiastych telemetrii.",
    ...
    contact: {
      ...
      err_invalid_message: "Opisz projekt w od 8 do 5000 znaków.",
